...
export const sectionContainerVariants = cva("mx-auto w-full", {
  variants: {
    size: {
      sm: "max-w-sm px-4 lg:px-12",
      default: "max-w-screen-xl px-4 lg:px-8",
    },
  },
  defaultVariants: {
    size: "default",
...
const sectionContentVariants = cva(
  [
    ...
    "[&_:is(p,ul,li,h1,h2,h3,h4,h5,h6)]:not-first:mt-4",
